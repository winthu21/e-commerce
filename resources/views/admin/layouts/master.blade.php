...
<body id="page-top">
    ...
    <div id="wrapper">
        ...
        <ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion" id="accordionSidebar">
            ...
            <li class="nav-item">
                <a class="nav-link" href="{{ route('categoryList') }}"><i class="fa-solid fa-sitemap"></i></i><span>Category </span></a>
            </li>

            <li class="nav-item">
                <a class="nav-link" href="{{ route('categoryCreate') }}"><i class="fa-solid fa-circle-plus"></i></i><span>Add Category </span></a>
            </li>
            ...
            <li class="nav-item">
                <a class="nav-link" href="{{ route('productCreatePage') }}"><i class="fa-solid fa-plus"></i></i><span>Add Product </span></a>
            </li>

            <li class="nav-item">
                <a class="nav-link" href="{{ route('adminPaymentPage') }}"><i class="fa-solid fa-credit-card"></i></i><span>Payment Method </span></a>
            </li>
            ...
            <li class="nav-item">
                <a class="nav-link" href="{{ route('orderBoardPage') }}"><i class="fa-solid fa-cart-shopping"></i><span>Order Board </span></a>
            </li>

            <li class="nav-item">
                <a class="nav-link" href="{{ route('adminListPage') }}"><i class="fa-solid fa-users"></i><span>Admin and User List </span></a>
            </li>
            ...
            <li class="nav-item">
                <a class="nav-link" href="{{ route('adminCreatePage') }}"><i class="fa-solid fa-gear"></i></i><span>Create New Admin Account </span></a>
            </li>
                    ...
                    <ul class="navbar-nav ml-auto">
                        ...
                        <li class="nav-item dropdown no-arrow">
                            ...
                            <div class="dropdown-menu dropdown-menu-right shadow animated--grow-in"
                                ...
                                <a class="dropdown-item" href="{{ route('profileDetailsPage') }}">
